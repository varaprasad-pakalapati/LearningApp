...
public class YoutubeActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    private YouTubePlayer.PlaybackEventListener playbackEventListener = new YouTubePlayer.PlaybackEventListener() {
        ...
        public void onPlaying() {
            Toast.makeText(YoutubeActivity.this, "Video started playing", Toast.LENGTH_LONG).show();
        }
    ...
    private YouTubePlayer.PlayerStateChangeListener playerStateChangeListener = new YouTubePlayer.PlayerStateChangeListener() {
        ...
        public void onAdStarted() {
            Toast.makeText(YoutubeActivity.this, "Ohhh, Go to hellll..", Toast.LENGTH_LONG).show();
        }

        @Override
        public void onVideoStarted() {
            Toast.makeText(YoutubeActivity.this, "Thank Godd..", Toast.LENGTH_LONG).show();
        }
